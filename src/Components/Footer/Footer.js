                        ...
                        <div className="footer-right">
                            <ul className="footer_content">
                                ...
                                <li className="footer_content-link fw">
                                    <img src={Linkedin} class="footer_content-logo" alt="no-logo"/>
                                    <a href="#">Linkedin</a>
                                </li>
                                <li className="footer_content-link fw">
                                    <img src={Telegram} class="footer_content-logo" alt="no-logo"/>                             
                                    <a href="#">Telegram</a>
                                </li>
                                <li className="footer_content-link fw">
                                    <img src={Whatsapp} class="footer_content-logo" alt="no-logo"/>                                                            
                                    <a href="#">Whatsapp</a>
                                </li>
                                <li className="footer_content-link fw">
                                    <img src={Facebook} class="footer_content-logo" alt="no-logo"/>
                                    <a href="#">Facebook</a>
                                </li>
                                <li className="footer_content-link fw">
                                    <img src={Mail} class="footer_content-logo" alt="no-logo"/>
                            ...
                            <ul className="footer_content">
                                ...
                                <li className="footer_content-link fw">
                                    <img src={Behance} class="footer_content-logo" alt="no-logo"/>

                                    <a href="#">Behance</a>
                                </li>
                                <li className="footer_content-link fw">
                                    <img src={YouTube} class="footer_content-logo" alt="no-logo"/>                                                            
                                    <a href="#">YouTube</a>
                                </li>
                                <li className="footer_content-link fw">
                                    <img src={Instagram} class="footer_content-logo" alt="no-logo"/>                              
                                    <a href="#">Instagram</a>
                                </li>
                                <li className="footer_content-link fw">
                                    <img src={Medium} class="footer_content-logo" alt="no-logo"/>
                                    <a href="#">Medium</a>
                                </li>
                                <li className="footer_content-link fw">
                                    <img src={Habr} class="footer_content-logo" alt="no-logo"/>
                                    <a href="#">Habr</a>
                                </li>
                            </ul>
                        </div>
