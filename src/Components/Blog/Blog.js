                ...
                <div className="container">
                    ...
                    <div className="blog-cards">
                        <div className="blog-cards_item">
                            <h5>Standardization of color schemes through the eyes of a programmer</h5>
                            <p>Let’s try to figure out how designers use colors in UI and how the whole thing can be standardized without restricting designers</p>
                            <a href="#">
                                <svg class="blog-medium_icon" width="30" height="24" viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg">
